...
def setUp():
    ...
    returncode = subprocess.call(["rsync","-vpogtIrk","--progress","{}/".format(source_dist_dir), "{}/".format(cordova_dist_dir),"--exclude","node_modules".format(source_dist_dir),"--exclude","*.js.map"])
    if returncode != 0:
